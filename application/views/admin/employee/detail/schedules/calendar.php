    ...
    <div class="col-md-3">
        <div class="box box-primary">
            <div class="box-header">
                <h4 class="box-title">Events Template</h4>
            </div>
            <div class="box-body">
                <!-- the events -->
                <div id='external-events'>
                    <div class='external-event bg-green'>Lunch</div>
                    <div class='external-event bg-red'>Coding</div>
                    <div class='external-event bg-aqua'>Testing</div>
                    <div class='external-event bg-yellow'>Work on UI design</div>
                    <div class='external-event bg-navy'>Meeting</div>
                    <p>
    ...
    $(function() {
        ...
        $('#calendarx').fullCalendar({
            ...
            drop: function(date, allDay) { // this function is called when something is dropped
                ...
                $('#calendarx').fullCalendar('renderEvent', copiedEventObject, true);
